...
class AbstractRuleSet(_PredictionModel, ABC):
    ...
    def get_condition_frequent(self) -> dict[str, int]:
        ...
        def traverse(condition: object) -> None:
            if hasattr(condition, "subconditions") and condition.subconditions:
                ...
                key = condition.to_string(self.column_names)
    ...
    def get_attribute_frequent(self) -> dict[str, int]:
        """
            ...
            if hasattr(condition, "subconditions") and condition.subconditions:
                ...
                if hasattr(condition, "column_left") and hasattr(condition, "column_right"):
                    if self.column_names is not None:
                        attr_left = self.column_names[condition.column_left]
                        attr_right = self.column_names[condition.column_right]
                    else:
                ...
                # Otherwise, if condition has a single column_index attribute
                    ...
                    if self.column_names is not None:
                        attr_name = self.column_names[condition.column_index]
                    else:
